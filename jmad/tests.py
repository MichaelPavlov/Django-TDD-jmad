...
class StudentTestCase(LiveServerTestCase):
    ...
    def test_staff_can_add_content(self):
        """
        Test that a 'staff' user can access the admin and add Albums, Tracks and Solos
        """
        ...
        # He can tell he's in the right place because off the title of the page
        ...
        # Going back to the home page, he clicks the Tracks link and sees the Tracks that have been added. They're orderes first by Album, then by track number.
        ...
        self.assertEqual(track_rows[1].text, 'Kind of Blue All Blues -')
        self.assertEqual(track_rows[2].text, 'Kind of Blue Freddie Freeloader 2')
        self.assertEqual(track_rows[3].text, 'Kind of Blue Blue in Green 3')
        ...
        # He adds the track to an album that already exists
        ...
        result_list = self.browser.find_elements_by_css_selector('#result_list tr')
        self.assertEqual(
            self.browser.find_elements_by_css_selector('#result_list tr')[2].text,
        ...
        self.assertEqual(solo_rows[4].text.strip(), 'My Favorite Things Jhon Coltrane')
